package com.pms.patient_service.facade;
...
import com.pms.patient_service.strategy.notification.NotificationOrchestrator;
...
public class PatientFacade {
    ...
    public PatientResponseDTO createPatient(PatientRequestDTO dto) {
        ...
        return patientService.toResponseDTO(created);
    }
    ...
    public PatientResponseDTO createPatient(PatientGrpcRequestDTO dto) {
        ...
        return patientService.toResponseDTO(saved);
    }
    ...
    public PatientResponseDTO updatePatient(UUID id, PatientRequestDTO dto) {
        ...
        return patientService.toResponseDTO(updated);
    }
