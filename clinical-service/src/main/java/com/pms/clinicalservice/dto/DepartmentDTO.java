...
public record DepartmentDTO(String departmentId, String name, String hospitalId, String hospitalName) {
    ...
    public static class DepartmentDTOBuilder {
        ...
        public DepartmentDTOBuilder departmentId(String departmentId) { this.departmentId = departmentId; return this; }
        public DepartmentDTOBuilder name(String name) { this.name = name; return this; }
        public DepartmentDTOBuilder hospitalId(String hospitalId) { this.hospitalId = hospitalId; return this; }
        public DepartmentDTOBuilder hospitalName(String hospitalName) { this.hospitalName = hospitalName; return this; }
