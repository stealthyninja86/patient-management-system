    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.POST, "/appointments/*/start").hasAnyRole("ADMIN", "DOCTOR")
                .requestMatchers(HttpMethod.POST, "/appointments/*/complete").hasAnyRole("ADMIN", "DOCTOR")
                .requestMatchers(HttpMethod.POST, "/appointments/*/cancel").hasAnyRole("ADMIN", "DOCTOR", "PATIENT")
                ...
                .requestMatchers(HttpMethod.POST, "/time-slots").hasAnyRole("ADMIN", "DOCTOR")
